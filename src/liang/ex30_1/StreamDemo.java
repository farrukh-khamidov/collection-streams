...
public class StreamDemo {
    public static void main(String[] args) {
        ...
        System.out.println("Largest length string with length > 4: "
                + Stream.of(names)
                .filter(e -> e.length() > 4)
        ...
        System.out.println("Any names start with a capital letter? "
                + Stream.of(names)
                .anyMatch(e -> Character.isUpperCase(e.charAt(0))));

        System.out.println("no names start with a capital letter? "
                + Stream.of(names)
                .noneMatch(e -> Character.isUpperCase(e.charAt(0))));
